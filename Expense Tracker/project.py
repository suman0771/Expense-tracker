'''    firstly install following Modules:
                                          tkcalendar
                                          matplotlib
                                          numpy
                                          sqlite3
...
def populateTransaction(frame):
    Label(frame, text="Your Transactions", width=rootWidth, height=3, anchor=CENTER, bg='blue4', fg='gold', bd=4,
    ...
    Label(searchFrame, text="From", font=('Lucida Console', '12', 'bold'), bg='purple', fg='white', width=10).grid(
        row=0, column=1)
    startDate_E = DateEntry(searchFrame, width=20, bd=3, date_pattern='yyyy/mm/dd')
    startDate_E.grid(row=0, column=2, pady=5)
    Label(searchFrame, text="To", font=('Lucida Console', '12', 'bold'), bg='purple', width=10, fg='white').grid(row=1,
                                                                                                                 column=1)
        ...
        for r in cursor:
            if r[3] == 'expense':
                ...
                Label(dataFrame, text="%s - (%s) :" % (r[1], r[5]), width=50, height=3, borderwidth='1', relief='solid',
                      bg='red3', pady=3, fg='white', font=('Copperplate Gothic Bold', '13')).grid(row=i, column=1)
                Label(dataFrame, text='Rs. %s' % (r[4]), width=50, height=3, borderwidth='1', bg='red3', relief='solid',
                ...
                Label(dataFrame, text="%s - (%s) :" % (r[1], r[5]), width=50, height=3, borderwidth='1', relief='solid',
                      bg='green', pady=3, fg='white', font=('Copperplate Gothic Bold', '13')).grid(row=i, column=1)
                Label(dataFrame, text='Rs. %s' % (r[4]), width=50, height=3, borderwidth='1', bg='green',
    ...
    Button(searchFrame, text="Search", width=10, command=search, bg='gold', activebackground='green2',
           font=('Brush Script MT', '18')).grid(row=2, column=2, pady=10)
    ...
    for r in cursor:
        ...
        Label(dataFrame, text="%s - (%s)" % (r[1], r[5]), width=50, height=3, borderwidth='1', relief='solid',
              bg='red3', pady=3, fg='white', font=('Copperplate Gothic Bold', '13')).grid(row=i, column=1)
        Label(dataFrame, text='Rs. %s' % (r[4]), width=50, height=3, borderwidth='1', bg='red3', relief='solid', pady=3,
    ...
    for r in cursor:
        ...
        Label(dataFrame, text="%s - (%s) :" % (r[1], r[5]), width=50, height=3, borderwidth='1', relief='solid',
              bg='green', pady=3, fg='white', font=('Copperplate Gothic Bold', '13')).grid(row=i, column=1)
        Label(dataFrame, text='Rs. %s' % (r[4]), width=50, height=3, borderwidth='1', bg='green', relief='solid',
              pady=3, fg='white', font=('Copperplate Gothic Bold', '13')).grid(row=i, column=2)
        i += 1
...
def populateHome(frame):
    ...
    def transaction1():
        ...
        Radiobutton(tran_win, text="Expense", variable=v, value=1, command=event).grid(row=2, column=0, sticky=W,
                                                                                       pady=2)
        ...
        def add_to_database():
            try:
                ...
                conn.commit()
                Label(tran_win, text="Transaction Added", fg="green", font=("calibri", 11)).grid(row=8, column=3,
                                                                                                 sticky=W, pady=2)
                tran_win.destroy()
            except:
                Label(tran_win, text="Transaction Failed!! Try Again", fg="red", font=("calibri", 11)).grid(row=8,
                                                                                                            column=3,
                                                                                                            sticky=W,
                                                                                                            pady=2)
    ...
    for r in cursor2:
        if r[0] == None:
            ...
            expBal = r[0]
    Label(userInfo, text="USER NAME : ", width=20, bg='red', fg='white', font=('Copperplate Gothic Bold', '10')).grid(
        row=0, column=0, pady=5)
    Label(userInfo, text="%s" % (uname), width=20, bg='red', fg='white', font=('Copperplate Gothic Bold', '10')).grid(
        row=0, column=1, pady=5)
    Label(userInfo, text="Account Balance : ", width=20, bg='red', fg='white',
          font=('Copperplate Gothic Bold', '10')).grid(row=1, column=0, pady=5)
    Label(userInfo, text="Rs. %d" % (amtBal), width=20, bg='red', fg='white',
          font=('Copperplate Gothic Bold', '10')).grid(row=1, column=1, pady=5)
    Label(userInfo, text="Expense total : ", width=20, bg='red', fg='white',
          font=('Copperplate Gothic Bold', '10')).grid(row=2, column=0, pady=5)
    Label(userInfo, text="Rs %d" % (expBal), width=20, bg='red', fg='white',
          font=('Copperplate Gothic Bold', '10')).grid(row=2, column=1, pady=5)
    Button(userInfo, text='Add Transaction', command=transaction1, width=20, bg='cyan2', fg='blue2',
...
def populateItemTracker(frame):
    Label(frame, text="ITem Trackering for this month", width=rootWidth, height=3, anchor=CENTER, bg='blue4', fg='gold',
          bd=4, font=('Algerian', '14', 'bold')).pack()
    ...
    def setBudget():
        ...
        Label(top, text='Enter item', pady=5, padx=5, font=('Britannic Bold', '10'), fg='yellow', bg='blue4').grid(
            row=0, column=1, pady=5)
        setE1 = Entry(top, width=30)
        setE1.grid(row=0, column=2, pady=5)
        Label(top, text='Set Budget', pady=5, padx=5, font=('Britannic Bold', '10'), fg='yellow', bg='blue4').grid(
        ...
        Button(top, text='SET', command=change, width=10, height=1, bd=2, fg='yellow', bg='blue4', pady=4,
               font=('Britannic Bold', '13')).grid(row=2, column=2, pady=10)
        top.minsize(400, 150)
        top.mainloop()

    Button(scaleFrame, text='Set item Budget', command=setBudget, fg='gold', bg='blue4', width=20, height=2,
           relief='solid', font=('Broadway', '16')).grid(row=i + 1, column=0, columnspan=3, pady=20, padx=20)


def populateTagSummary(frame):
    Label(frame, text="This Month's Expense", width=rootWidth, height=3, anchor=CENTER, bg='blue4', fg='gold', bd=4,
          font=('Algerian', '13', 'bold')).pack()
    ...
    for r in cursor:
        if r[0] == None:
            ...
            sum += r[0]
            flag1 = 1
    Label(expenseFrame, text='Expense', pady=5, width=50, height=3, borderwidth='1', relief='solid', bg='red3',
          fg='white', font=('Copperplate Gothic Bold', '13')).grid(row=0, column=0)
    Label(expenseFrame, text='Rs. %s' % str(sum), pady=5, width=50, height=3, borderwidth='1', relief='solid',
          bg='red3', fg='white', font=('Copperplate Gothic Bold', '13')).grid(row=0, column=1)
    ...
    if flag1 == 1:
        ...
        for r in cursor:
            Label(expenseFrame, text="%s" % r[2], pady=5, width=50, height=3, borderwidth='1', relief='solid',
                  bg='red4', fg='white', font=('Copperplate Gothic Bold', '13')).grid(row=i, column=0)
            Label(expenseFrame, text="%s" % r[4], pady=5, width=50, height=3, borderwidth='1', relief='solid',
                  bg='red4', fg='white', font=('Copperplate Gothic Bold', '13')).grid(row=i, column=1)
            i += 1
    ...
    for r in cursor:
        if r[0] == None:
            ...
            sum += r[0]
            flag2 = 1
    Label(expenseFrame, text='Income', pady=5, width=50, height=3, borderwidth='1', relief='solid', bg='SpringGreen4',
          fg='white', font=('Copperplate Gothic Bold', '13')).grid(row=i, column=0)
    Label(expenseFrame, text='Rs. %s' % str(sum), pady=5, width=50, height=3, borderwidth='1', relief='solid',
          bg='SpringGreen4', fg='white', font=('Copperplate Gothic Bold', '13')).grid(row=i, column=1)
    i += 1
    ...
    if flag2 == 1:
        ...
        for r in cursor:
            Label(expenseFrame, text="%s" % r[2], pady=5, width=50, height=3, borderwidth='1', relief='solid',
                  bg='green', fg='white', font=('Copperplate Gothic Bold', '13')).grid(row=i, column=0)
            Label(expenseFrame, text="%s" % r[4], pady=5, width=50, height=3, borderwidth='1', relief='solid',
                  bg='green', fg='white', font=('Copperplate Gothic Bold', '13')).grid(row=i, column=1)
            i += 1
...
def registration():
    ...
    top.grid_columnconfigure(2, weight=2)
    top.grid_columnconfigure(3, weight=1)
    Label(top, text='Enter Name', pady=5, height=1, padx=5, font=('Britannic Bold', '10'), fg='yellow',
          bg='blue4').grid(row=0, column=1, pady=10)
    regE1 = Entry(top, width=30)
    regE1.grid(row=0, column=2, pady=5)
    Label(top, text='Set Password', pady=5, height=1, padx=5, font=('Britannic Bold', '10'), fg='yellow',
          bg='blue4').grid(row=1, column=1, pady=5)
    regE2 = Entry(top, width=30)
    regE2.grid(row=1, column=2, pady=5)
    Label(top, text='Enter Balance', pady=5, height=1, padx=5, font=('Britannic Bold', '10'), fg='yellow',
          bg='blue4').grid(row=2, column=1, pady=5)
    ...
    Button(top, text='Register', command=change, width=10, height=1, bd=2, fg='yellow', bg='blue4', pady=4,
...
def populateUser(frame):
    Label(frame, text="Welcome Expense Tracker", width=rootWidth, height=3, anchor=CENTER, bg='blue4', fg='gold', bd=4,
          font=('Algerian', '13', 'bold')).pack()
    Label(frame, text='Please sign up/ login to continue', pady=5, width=rootWidth, height=3, anchor=CENTER, bg='blue4',
          fg='gold', bd=4, font=('Algerian', '13', 'bold')).pack()
    login = Frame(frame, pady=10)
    login.pack(fill=BOTH, expand=True)
    login.grid_columnconfigure(0, weight=1)
    login.grid_columnconfigure(1, weight=1)
    Label(login, text='Enter User Name :', width=30, fg="light grey", bg='saddle brown',
          font=('Bernard MT Condensed', '14')).grid(row=0, column=0, pady=10)
    ue1 = Entry(login, width=30, bg='cyan')
    ue1.grid(row=0, column=1, pady=10)
    Label(login, text='Password :', width=30, fg="light grey", bg='saddle brown',
          font=('Bernard MT Condensed', '14')).grid(row=1, column=0, pady=10)
    ...
    Button(login, text='Login', width=20, height=2, fg="blue4", bg='dodger blue', command=userHelper,
           font=('Broadway', '14')).grid(row=2, column=0, pady=10)
    Button(login, text='Sign up', width=20, height=2, fg="blue4", bg='dodger blue', command=registration,
...
Button(frameTab, text="Home", relief="solid", width=50, height=2, bd=1, bg='yellow', fg='purple', command=homeHelper,
       font=("Times", "13", "bold italic")).grid(row=0, column=0)
Button(frameTab, text="Transaction", relief="solid", width=50, height=2, bd=1, bg='yellow', fg='purple',
       command=transactionHelper, font=("Times", "13", "bold italic")).grid(row=0, column=1)
Button(frameTab, text="Expense Summary", relief="solid", width=50, height=2, bd=1, bg='yellow', fg='purple',
       command=tagSummaryHelper, font=("Times", "13", "bold italic")).grid(row=0, column=2)
Button(frameTab, text="Item Budget", relief="solid", width=50, height=2, bd=1, bg='yellow', fg='purple',
       command=itemTrackerHelper, font=("Times", "13", "bold italic")).grid(row=0, column=3)
